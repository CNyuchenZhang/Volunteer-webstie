<template>
  <div class="header-layout">
    <div class="header-content">
      <div class="logo">
        <img style="width: auto; height: 60px;" :src="logoUrl[role]" alt="Volunteer Portal Logo">
      </div>
      <div class="nav">
        <!-- 深色主题 -->
        <el-menu
...
const menuItems = ref([
  { index: `/home/${route.params.role}`, name: 'Home' },
  { index: `/activity-zone/${route.params.role}`, name: 'Activity Zone' },
  { index: `/my-activity/${route.params.role}`, name: 'My Activity' },
]);
...
const handleUserClick = () => {
  router.push({ 
    path: `/user-profile/${route.params.role}`
  })
}
