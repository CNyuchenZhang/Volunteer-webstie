<template>
    <div class="activity-zone-detail">
        ...
        <el-breadcrumb :separator-icon="ArrowRight">
            <el-breadcrumb-item :to="`/activity-zone/${role}`">Activity Zone</el-breadcrumb-item>
            <el-breadcrumb-item>{{ activityZone.name }}</el-breadcrumb-item>
        </el-breadcrumb>
                ...
                <div class="content">
                    <el-form label-position="top">
                        <el-form-item label="Activity Zone Name">
                            <el-input v-model="activityZone.name" type="text" readonly></el-input>
                        </el-form-item>
                        <el-form-item label="Date">
                            <div class="activity-zone-date">
                                <div class="start-date">
                                    <el-input v-model="activityZone.startDate" type="text" readonly></el-input>
                                </div>
                                <div class="separator">-</div>
                                <div class="end-date">
                                    <el-input v-model="activityZone.endDate" type="text" readonly></el-input>
                                </div>
                            </div>
                        </el-form-item>
                        <el-form-item label="Address">
                            <el-input v-model="activityZone.address" type="textarea" :autosize="{ minRows: 1 }" resize="none" readonly></el-input>
                        </el-form-item>
                        <el-form-item label="Description">
                            <el-input v-model="activityZone.description" type="textarea" :autosize="{ minRows: 2, maxRows: 2 }" resize="none" readonly></el-input>
                        </el-form-item>
                    </el-form>
                </div>
            </div>
                ...
                <div class="content">
                    <el-form label-position="top">
                        ...
                        <el-form-item label="Contact Person">
                            <el-input v-model="activityZone.contactPerson" type="text" readonly></el-input>
                        </el-form-item>
                        <el-form-item label="Contact Tel">
                            <el-input v-model="activityZone.contactTel" type="text" readonly></el-input>
                        </el-form-item>
                        <el-form-item label="Contact Email">
                            <el-input v-model="activityZone.contactEmail" type="text" readonly></el-input>
                        </el-form-item>
                    </el-form>
                </div>
                <div class="footer">
                    <el-button type="primary" size="default" @click="handleRegister">Register Now</el-button>
                </div>
            </div>
        </div>
    </div>
...
const handleRegister = () => {
    ...
    `
        <div style="text-align: center;">
            <p>If register, cannot cancel.</p>
            <p>Think twice before you move on.</p>
        </div>
    `, 
    '', 
    {
