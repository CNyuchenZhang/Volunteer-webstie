...
# SECRET_KEY = config('SECRET_KEY', default='django-insecure-notification-service-key-change-in-production')
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "dev-only-unsafe")  # 开发占位；生产必须注入
...
MIDDLEWARE = [
    ...
    'csp.middleware.CSPMiddleware',  # 新增
]
